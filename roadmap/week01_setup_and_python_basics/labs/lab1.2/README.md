# Data Engineering Roadmap - Assignment 2

### 🗓️ Lab 2.1: Sensor Data Quality Check (Production Simulation)

The first dive into the course introduces to the python. In this assignment we are implementing all the basics python we have learnt so far that includes basic syntax(variables, keywords, data-types, conditionals and loops)

the idea of this assignment is to write a simple program that
